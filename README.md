...
A custom Minesweeper implementation built with C++17 and SFML, featuring clean architecture and plans for unique game modes and procedural generation elements.
